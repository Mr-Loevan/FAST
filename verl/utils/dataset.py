...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Preserve image_complexity if it exists in the original data
        if "image_complexity" in self.dataset[index]:
            example["image_complexity"] = self.dataset[index]["image_complexity"]
