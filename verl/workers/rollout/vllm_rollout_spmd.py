...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto) -> DataProto:
        ...
        # Preserve other fields like ground_truth, image_complexity
        preserved_fields = {k: v for k, v in non_tensor_batch.items()}
        ...
        with self.update_sampling_params(**prompts.meta_info):
            ...
            if self.sampling_params.n > 1:
                ...
                # Repeat preserved fields for sampling n > 1
                for key in preserved_fields:
                    preserved_fields[key] = _repeat_interleave(preserved_fields[key], self.sampling_params.n)
        ...
        # Rebuild non_tensor_batch with preserved fields
        non_tensor_batch = preserved_fields.copy()
        if batch_multi_modal_data is not None:
